...
- **F6** — Source review finds a second router/client, private Element/store dependency, unsupported direct host DOM operation, or required Element core change.
