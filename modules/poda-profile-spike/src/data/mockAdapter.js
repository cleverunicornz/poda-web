...
export class MockPodaDataAdapter {
    ...
    async savePodcast(draft) {
        ...
        const podcast = {
            ...
            currentness: { canonicalAt: null, activityFreshnessAt: timestamp, internalizedAt: timestamp, externalizedAt: null },
    ...
    async saveEpisode(draft) {
        ...
        const episode = {
            ...
            publishedAt: null,
            scheduledAt: null,
            item: { persons: [], transcripts: [], funding: [], soundbites: [], locations: [], chapters: null, license: null },
            media: { primaryEnclosure: null, alternateEnclosures: [] },
            currentness: { canonicalAt: null, activityFreshnessAt: timestamp, internalizedAt: null, externalizedAt: null },
