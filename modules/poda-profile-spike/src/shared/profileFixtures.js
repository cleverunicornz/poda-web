...
export const PROFILE_FIXTURE_MIRA = {
    ...
    aboutShort:
        "Helps founder-led teams run high-stakes product launches without burning out the humans doing the work.",
    slug: "mira-chen",
    isPublic: true,
    ...
    expertiseCards: [
        {
            id: "exp-1",
            title: "Launch operating systems",
            description: "Runbooks, checklists, and team rhythms for launch weeks.",
            icon: "Target",
            order: 1,
        },
        {
            id: "exp-2",
            title: "AI research loops",
            description: "Practical agent-assisted briefing and synthesis workflows.",
            icon: "Sparkles",
            order: 2,
        },
    ],
    ...
    mediaKit: [
        {
            id: "mk-1",
            name: "Headshots pack",
            url: "https://example.com/mk/headshots.zip",
            type: "headshot",
            size: 2411724,
            filename: "mira-headshots.zip",
            mimeType: "application/zip",
        },
        {
            id: "mk-2",
            name: "One-sheet PDF",
            url: "https://example.com/mk/onesheet.pdf",
            type: "pdf",
            size: 184320,
            filename: "mira-onesheet.pdf",
    ...
    testimonials: [
        {
            id: "t-1",
            name: "Jordan Park",
            role: "Host, Ship It Weekly",
            quote: "Mira turned our chaos into a checklist our whole team actually uses.",
            order: 1,
        },
        {
            id: "t-2",
            name: "Sam Rivera",
            role: "CTO, Northbeam",
            quote: "The calmest launch we have ever run. Twice.",
            order: 2,
        },
    ],
    featuredAppearances: [
        {
            id: "fa-1",
            podcastName: "Launch Notes",
            episodeTitle: "Systems that do not collapse",
        ...
        {
            id: "fa-2",
            podcastName: "Founder Office Hours",
            episodeTitle: "Research loops with agents",
            url: "https://example.com/ep/18",
            date: "2026-03-02",
            imageUrl: null,
            order: 2,
            displayClass: "platform_mutual",
        },
    ],
    appearanceCount: 12,
